          ...
          <div className="flex items-center gap-6 flex-1 h-full">
            ...
            <nav className="hidden md:flex items-center gap-6 h-full min-h-[144px]">
              ...
              <div className="relative group h-[144px]">
                ...
                <div className="hidden group-hover:block absolute left-0 top-full -mt-1 w-44 bg-white border shadow-lg rounded-md z-50">
              ...
              <div className="relative group h-[144px]">
                ...
                <div className="hidden group-hover:block absolute left-0 top-full -mt-1 w-64 bg-white border shadow-lg rounded-md z-50 p-3">
