...
export default function LeaveReviewForm() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      setError("Something went wrong. Please try again or call us at (747) 463-1853.");
    } finally {
      setSubmitting(false);
    }
  }
  ...
  if (submitted) {
    return (
      <div className="bg-green-50 border border-green-200 rounded-xl p-8 text-center">
        ...
        <a href="/" className="inline-block px-6 py-3 border border-gray-200 rounded-lg">
          Back to Home
        </a>
      </div>
    );
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white rounded-xl p-6 shadow-sm space-y-4">
      ...
      <div className="flex gap-2">
        ...
        <a href="/" className="px-4 py-2 border border-gray-200 rounded">
          Cancel
        </a>
      </div>
    </form>
